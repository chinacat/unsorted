...
(define (prove-goals goal-list bindings success-cont failure-cont)
  (cond
    ...
    [else (search-choices (car goal-list)
                          bindings
                          (lambda (b2 fc2)
                            (prove-goals (cdr goal-list) b2 success-cont fc2))
                          failure-cont)]))

(define (prove goal clause bindings success-cont failure-cont)
